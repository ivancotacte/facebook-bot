...
var ClipCreationScrubber = class extends YTNode {
  constructor(data) {
    ...
    this.start_label = (_b = (_a3 = data.startAccessibility) === null || _a3 === void 0 ? void 0 : _a3.accessibilityData) === null || _b === void 0 ? void 0 : _b.label;
...
var VideoAttributeView = class extends YTNode {
  constructor(data) {
    var _a3;
    super();
    if ((_a3 = data.image) === null || _a3 === void 0 ? void 0 : _a3.sources) {
      this.image = Thumbnail.fromResponse(data.image);
    } else {
...
var AvatarView = class extends YTNode {
  constructor(data) {
    super();
    this.image = {
      sources: data.image.sources.map((x) => new Thumbnail(x)).sort((a, b) => b.width - a.width),
      processor: {
...
var Playlist = class extends YTNode {
  constructor(data) {
    ...
    this.title = new Text(data.title);
    this.author = ((_a3 = data.shortBylineText) === null || _a3 === void 0 ? void 0 : _a3.simpleText) ? new Text(data.shortBylineText) : new Author(data.longBylineText, data.ownerBadges, null);
...
var DecoratedAvatarView = class extends YTNode {
  constructor(data) {
    super();
    this.avatar = new AvatarView_default(data.avatar.avatarViewModel);
    this.a11y_label = data.a11yLabel;
    this.on_tap_endpoint = new NavigationEndpoint_default(data.rendererContext.commandContext.onTap.innertubeCommand);
  }
};
...
var LiveChatTickerPaidMessageItem = class extends YTNode {
  constructor(data) {
    ...
    this.show_item = parser_exports.parseItem((_b = (_a3 = data.showItemEndpoint) === null || _a3 === void 0 ? void 0 : _a3.showLiveChatItemEndpoint) === null || _b === void 0 ? void 0 : _b.renderer);
...
var ReplayChatItemAction = class extends YTNode {
  constructor(data) {
    var _a3;
    super();
    this.actions = parser_exports.parseArray((_a3 = data.actions) === null || _a3 === void 0 ? void 0 : _a3.map((action) => {
...
var TwoColumnWatchNextResults = class extends YTNode {
  constructor(data) {
    ...
    this.results = parser_exports.parseArray((_a3 = data.results) === null || _a3 === void 0 ? void 0 : _a3.results.contents);
...
var AccountInfo = class {
  constructor(response) {
    ...
    (0, import_tslib11.__classPrivateFieldSet)(this, _AccountInfo_page, parser_exports.parseResponse(response.data), "f");
...
var Analytics = class {
  constructor(response) {
    ...
    (0, import_tslib12.__classPrivateFieldSet)(this, _Analytics_page, parser_exports.parseResponse(response.data), "f");
...
var Feed = class {
  constructor(actions, response, already_parsed = false) {
    ...
    if ((0, import_tslib13.__classPrivateFieldGet)(this, _Feed_instances, "m", _Feed_isParsed).call(this, response) || already_parsed) {
      ...
      (0, import_tslib13.__classPrivateFieldSet)(this, _Feed_page, parser_exports.parseResponse(response.data), "f");
    }
  ...
  get has_continuation() {
    return (0, import_tslib13.__classPrivateFieldGet)(this, _Feed_instances, "m", _Feed_getBodyContinuations).call(this).length > 0;
  }
  getContinuationData() {
    return (0, import_tslib13.__awaiter)(this, void 0, void 0, function* () {
      ...
      (0, import_tslib13.__classPrivateFieldSet)(this, _Feed_continuation, (0, import_tslib13.__classPrivateFieldGet)(this, _Feed_instances, "m", _Feed_getBodyContinuations).call(this), "f");
      if ((0, import_tslib13.__classPrivateFieldGet)(this, _Feed_continuation, "f"))
...
_Feed_page = /* @__PURE__ */ new WeakMap(), _Feed_continuation = /* @__PURE__ */ new WeakMap(), _Feed_actions = /* @__PURE__ */ new WeakMap(), _Feed_memo = /* @__PURE__ */ new WeakMap(), _Feed_instances = /* @__PURE__ */ new WeakSet(), _Feed_isParsed = /* @__PURE__ */ __name(function _Feed_isParsed2(response) {
  ...
  if ((0, import_tslib13.__classPrivateFieldGet)(this, _Feed_page, "f").header_memo) {
    const header_continuations = (0, import_tslib13.__classPrivateFieldGet)(this, _Feed_page, "f").header_memo.getType(ContinuationItem_default);
    return (0, import_tslib13.__classPrivateFieldGet)(this, _Feed_memo, "f").getType(ContinuationItem_default).filter((continuation) => !header_continuations.includes(continuation));
  }
  return (0, import_tslib13.__classPrivateFieldGet)(this, _Feed_memo, "f").getType(ContinuationItem_default);
...
var Channel2 = class extends TabbedFeed_default {
  ...
  getAbout() {
    ...
    return (0, import_tslib16.__awaiter)(this, void 0, void 0, function* () {
      ...
      } else if (((_a3 = this.header) === null || _a3 === void 0 ? void 0 : _a3.is(C4TabbedHeader_default)) && this.header.tagline) {
        if (this.header.tagline.more_endpoint instanceof NavigationEndpoint_default) {
          const response2 = yield this.header.tagline.more_endpoint.call(this.actions);
          const tab = new TabbedFeed_default(this.actions, response2, false);
          return tab.memo.getType(ChannelAboutFullMetadata_default)[0];
        }
        const endpoint = (_c = (_b = this.page.header_memo) === null || _b === void 0 ? void 0 : _b.getType(ContinuationItem_default)[0]) === null || _c === void 0 ? void 0 : _c.endpoint;
        if (!endpoint) {
  ...
  get has_about() {
    var _a3, _b;
    return this.hasTabWithURL("about") || !!(((_a3 = this.header) === null || _a3 === void 0 ? void 0 : _a3.is(C4TabbedHeader_default)) && ((_b = this.header.tagline) === null || _b === void 0 ? void 0 : _b.more_endpoint));
  }
  get has_search() {
    var _a3;
...
var Comments = class {
  constructor(actions, data, already_parsed = false) {
    ...
    (0, import_tslib17.__classPrivateFieldSet)(this, _Comments_page, already_parsed ? data : parser_exports.parseResponse(data), "f");
...
var NotificationsMenu = class {
  constructor(actions, response) {
    ...
    (0, import_tslib28.__classPrivateFieldSet)(this, _NotificationsMenu_page, parser_exports.parseResponse(response.data), "f");
...
var Settings = class {
  constructor(actions, response) {
    ...
    (0, import_tslib30.__classPrivateFieldSet)(this, _Settings_page, parser_exports.parseResponse(response.data), "f");
    ...
    this.sections = contents === null || contents === void 0 ? void 0 : contents.map((el) => {
      var _a4;
      return {
        title: ((_a4 = el.header) === null || _a4 === void 0 ? void 0 : _a4.is(CommentsHeader_default, ItemSectionHeader_default, ItemSectionTabbedHeader_default)) ? el.header.title.toString() : null,
...
var TimeWatched = class {
  constructor(response) {
    ...
    (0, import_tslib31.__classPrivateFieldSet)(this, _TimeWatched_page, parser_exports.parseResponse(response.data), "f");
...
var TranscriptInfo = class {
  constructor(actions, response) {
    ...
    (0, import_tslib38.__classPrivateFieldSet)(this, _TranscriptInfo_page, parser_exports.parseResponse(response.data), "f");
...
var MediaInfo = class {
  constructor(data, actions, cpn) {
    ...
    const next = ((_a3 = data === null || data === void 0 ? void 0 : data[1]) === null || _a3 === void 0 ? void 0 : _a3.data) ? parser_exports.parseResponse(data[1].data) : void 0;
...
var VideoInfo = class extends MediaInfo_default {
  constructor(data, actions, cpn) {
    var _a3, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o, _p, _q, _r, _s, _t, _u, _v, _w, _x, _y, _z, _0, _1, _2, _3, _4, _5, _6, _7, _8, _9, _10, _11, _12, _13, _14, _15, _16, _17, _18, _19;
    ...
    if (this.streaming_data) {
      ...
      } else if (((_r = this.captions) === null || _r === void 0 ? void 0 : _r.caption_tracks) && ((_s = this.captions) === null || _s === void 0 ? void 0 : _s.caption_tracks.length) > 0) {
    ...
    if (results && secondary_results) {
      ...
      const segmented_like_dislike_button_view = (_16 = (_15 = this.primary_info) === null || _15 === void 0 ? void 0 : _15.menu) === null || _16 === void 0 ? void 0 : _16.top_level_buttons.firstOfType(SegmentedLikeDislikeButtonView_default);
      ...
      const comments_entry_point = (_17 = results.get({ target_id: "comments-entry-point" })) === null || _17 === void 0 ? void 0 : _17.as(ItemSection_default);
      this.comments_entry_point_header = (_18 = comments_entry_point === null || comments_entry_point === void 0 ? void 0 : comments_entry_point.contents) === null || _18 === void 0 ? void 0 : _18.firstOfType(CommentsEntryPointHeader_default);
      this.livechat = (_19 = next === null || next === void 0 ? void 0 : next.contents_memo) === null || _19 === void 0 ? void 0 : _19.getType(LiveChat_default).first();
    }
  }
  ...
  like() {
    var _a3, _b, _c, _d, _e;
    return (0, import_tslib40.__awaiter)(this, void 0, void 0, function* () {
      const segmented_like_dislike_button_view = (_b = (_a3 = this.primary_info) === null || _a3 === void 0 ? void 0 : _a3.menu) === null || _b === void 0 ? void 0 : _b.top_level_buttons.firstOfType(SegmentedLikeDislikeButtonView_default);
      if (segmented_like_dislike_button_view) {
...
function build22(opts) {
  ...
  return {
    playerRequest: {
      ...
      params: (_a3 = opts.params) !== null && _a3 !== void 0 ? _a3 : "CAUwAg%3D%3D"
    },
...
var VideoInfo3 = class {
  constructor(data, actions) {
    ...
    const info = parser_exports.parseResponse(data[0].data);
    const watchNext = parser_exports.parseResponse(data[1].data);
    this.basic_info = info.video_details;
    this.watch_next_feed = (_a3 = watchNext.entries) === null || _a3 === void 0 ? void 0 : _a3.array();
    (0, import_tslib53.__classPrivateFieldSet)(this, _VideoInfo_watch_next_continuation2, (_b = watchNext.continuationEndpoint) === null || _b === void 0 ? void 0 : _b.as(ContinuationCommand), "f");
  }
  getWatchNextContinuation() {
    var _a3, _b;
    return (0, import_tslib53.__awaiter)(this, void 0, void 0, function* () {
      ...
      this.watch_next_feed = (_a3 = parsed.entries) === null || _a3 === void 0 ? void 0 : _a3.array();
      (0, import_tslib53.__classPrivateFieldSet)(this, _VideoInfo_watch_next_continuation2, (_b = parsed.continuationEndpoint) === null || _b === void 0 ? void 0 : _b.as(ContinuationCommand), "f");
      return this;
    });
  }
};
...
var Author = class {
  constructor(item, badges, thumbs, id) {
    var _a3, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o, _p, _q, _r, _s, _t, _u, _v, _w, _x, _y, _z, _0, _1, _2;
    const nav_text = new Text(item);
    this.id = id || ((_d = (_c = (_b = (_a3 = nav_text === null || nav_text === void 0 ? void 0 : nav_text.runs) === null || _a3 === void 0 ? void 0 : _a3[0]) === null || _b === void 0 ? void 0 : _b.endpoint) === null || _c === void 0 ? void 0 : _c.payload) === null || _d === void 0 ? void 0 : _d.browseId) || ((_f = (_e = nav_text === null || nav_text === void 0 ? void 0 : nav_text.endpoint) === null || _e === void 0 ? void 0 : _e.payload) === null || _f === void 0 ? void 0 : _f.browseId) || "N/A";
...
_OAuth_identity = /* @__PURE__ */ new WeakMap(), _OAuth_session = /* @__PURE__ */ new WeakMap(), _OAuth_credentials = /* @__PURE__ */ new WeakMap(), _OAuth_polling_interval = /* @__PURE__ */ new WeakMap(), _OAuth_instances = /* @__PURE__ */ new WeakSet(), _OAuth_loadCachedCredentials = /* @__PURE__ */ __name(function _OAuth_loadCachedCredentials2() {
  ...
  const poller = setInterval(() => (0, import_tslib58.__awaiter)(this, void 0, void 0, function* () {
    ...
    try {
      ...
      (0, import_tslib58.__classPrivateFieldSet)(this, _OAuth_credentials, {
        ...
        client_id: (_a3 = (0, import_tslib58.__classPrivateFieldGet)(this, _OAuth_identity, "f")) === null || _a3 === void 0 ? void 0 : _a3.client_id,
        client_secret: (_b = (0, import_tslib58.__classPrivateFieldGet)(this, _OAuth_identity, "f")) === null || _b === void 0 ? void 0 : _b.client_secret,
  ...
  return (0, import_tslib58.__awaiter)(this, void 0, void 0, function* () {
    ...
    (0, import_tslib58.__classPrivateFieldSet)(this, _OAuth_credentials, {
      ...
      client_id: (0, import_tslib58.__classPrivateFieldGet)(this, _OAuth_identity, "f").client_id,
      client_secret: (0, import_tslib58.__classPrivateFieldGet)(this, _OAuth_identity, "f").client_secret,
      expires: expiration_date
    }, "f");
  ...
  var _a3, _b, _c;
  return (0, import_tslib58.__awaiter)(this, void 0, void 0, function* () {
    if (((_a3 = (0, import_tslib58.__classPrivateFieldGet)(this, _OAuth_credentials, "f")) === null || _a3 === void 0 ? void 0 : _a3.client_id) && ((_b = this.credentials) === null || _b === void 0 ? void 0 : _b.client_secret)) {
      return {
        client_id: (0, import_tslib58.__classPrivateFieldGet)(this, _OAuth_credentials, "f").client_id,
    ...
    const url_body = (_c = OAUTH.REGEX.AUTH_SCRIPT.exec(response_data)) === null || _c === void 0 ? void 0 : _c[1];
    if (!url_body)
...
var { homepage, version, bugs } = { "homepage": "https://github.com/LuanRT/YouTube.js#readme", "version": "8.2.0", "bugs": { "url": "https://github.com/LuanRT/YouTube.js/issues" } };
