...
_OAuth_identity = new WeakMap(), _OAuth_session = new WeakMap(), _OAuth_credentials = new WeakMap(), _OAuth_polling_interval = new WeakMap(), _OAuth_instances = new WeakSet(), _OAuth_loadCachedCredentials = function _OAuth_loadCachedCredentials() {
    ...
    const poller = setInterval(() => __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            __classPrivateFieldSet(this, _OAuth_credentials, {
                ...
                client_secret: (_b = __classPrivateFieldGet(this, _OAuth_identity, "f")) === null || _b === void 0 ? void 0 : _b.client_secret,
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        __classPrivateFieldSet(this, _OAuth_credentials, {
            ...
            client_id: __classPrivateFieldGet(this, _OAuth_identity, "f").client_id,
            client_secret: __classPrivateFieldGet(this, _OAuth_identity, "f").client_secret,
            expires: expiration_date
        }, "f");
    ...
    var _a, _b, _c;
    return __awaiter(this, void 0, void 0, function* () {
        if (((_a = __classPrivateFieldGet(this, _OAuth_credentials, "f")) === null || _a === void 0 ? void 0 : _a.client_id) && ((_b = this.credentials) === null || _b === void 0 ? void 0 : _b.client_secret)) {
            return {
                client_id: __classPrivateFieldGet(this, _OAuth_credentials, "f").client_id,
        ...
        const url_body = (_c = Constants.OAUTH.REGEX.AUTH_SCRIPT.exec(response_data)) === null || _c === void 0 ? void 0 : _c[1];
        if (!url_body)
