...
class VideoInfo extends MediaInfo {
    ...
    constructor(data, actions, cpn) {
        ...
        if (results && secondary_results) {
            ...
            const segmented_like_dislike_button_view = (_16 = (_15 = this.primary_info) === null || _15 === void 0 ? void 0 : _15.menu) === null || _16 === void 0 ? void 0 : _16.top_level_buttons.firstOfType(SegmentedLikeDislikeButtonView);
            ...
            const comments_entry_point = (_17 = results.get({ target_id: 'comments-entry-point' })) === null || _17 === void 0 ? void 0 : _17.as(ItemSection);
            this.comments_entry_point_header = (_18 = comments_entry_point === null || comments_entry_point === void 0 ? void 0 : comments_entry_point.contents) === null || _18 === void 0 ? void 0 : _18.firstOfType(CommentsEntryPointHeader);
            this.livechat = (_19 = next === null || next === void 0 ? void 0 : next.contents_memo) === null || _19 === void 0 ? void 0 : _19.getType(LiveChat).first();
        }
    }
    /**
